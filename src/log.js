...
module.exports = {
	...
	workerLog: function(message, num){
		console.log(cyan + "["+getTime()+"] [Worker #"+num+"] [Log] "+ white +message);
		fs.appendFile("log.txt", "["+getTime()+"] [Log] "+message+"\r\n");
	},

	workerWarn: function(message, num){
		console.log(cyan + "["+getTime()+"]" + red + " [Worker #"+num+"] [Warn] "+ white +message);
		fs.appendFile("log.txt", "["+getTime()+"] [Warn] "+message+"\r\n");
	},

	workerHelp: function(message, num){
		console.log(cyan + "["+getTime()+"]" + yellow + " [Worker #"+num+"] [Help] "+ white +message);
		fs.appendFile("log.txt", "["+getTime()+"] [Help] "+message+"\r\n");
	}
